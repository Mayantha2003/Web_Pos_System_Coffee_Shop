...
$('#orders-table').on('click', 'tr', function () {
    ...
    let cust = order.customerId ? (getCustomerDataById(order.customerId)?.name || 'Walk-in') : 'Walk-in';
    ...
    order.items.map(i => {
        $('#od-items').append(`
            <div style="display:flex;justify-content:space-between;padding:7px 0;border-bottom:1px solid rgba(200,140,80,0.14);;font-size:13px;color:#c4a882; ">
